...
class Operations:
    ...
    def execute(self):
        for PC in range(0, len(self.opcode), 4):
            ...
            #Operações
            if self.opcode[PC] == '000':
                aux1 = int(self.opcode[PC+1][3]) + int(self.opcode[PC+1][2])*2 + int(self.opcode[PC+1][1])*4 + int(self.opcode[PC+1][0])*8
                aux2 = int(self.opcode[PC+2][3]) + int(self.opcode[PC+2][2])*2 + int(self.opcode[PC+2][1])*4 + int(self.opcode[PC+2][0])*8
                const = int(self.opcode[PC+3][4]) + int(self.opcode[PC+3][3])*2 + int(self.opcode[PC+3][2])*4 + int(self.opcode[PC+3][1])*8 + int(self.opcode[PC+3][0])*16
            ...
            elif self.opcode[PC] == '010':
                aux1 = int(self.opcode[PC+1][3]) + int(self.opcode[PC+1][2])*2 + int(self.opcode[PC+1][1])*4 + int(self.opcode[PC+1][0])*8
                aux2 = int(self.opcode[PC+2][3]) + int(self.opcode[PC+2][2])*2 + int(self.opcode[PC+2][1])*4 + int(self.opcode[PC+2][0])*8
                aux3 = int(self.opcode[PC+3][4]) + int(self.opcode[PC+3][3])*2 + int(self.opcode[PC+3][2])*4 + int(self.opcode[PC+3][1])*8 + int(self.opcode[PC+3][0])*16
